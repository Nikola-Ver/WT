...
<body>
    ...
    <form action="lab_7.php" class="input_div" method="post">
        <input name="email_sender" type="email" class="input_text" placeholder="Email отправителя">
        <input name="name" type="text" class="input_text" placeholder="Имя отправителя">
